...
<div className="photo-container-photo">
  ...
  <p className="rules-text">
    Эта игра — не экзамен и не марафон. Это бережное пространство для встречи с собой и друг с другом. 
    Совсем не обязательно проходить её целиком за один вечер: некоторые вопросы можно отпустить. 
    Но если вы решаете отвечать — делайте это от всего сердца, без масок. 
    И принимайте каждое услышанное слово как драгоценный дар, даже если оно вас удивляет. 
    В принятии рождается доверие.
  </p>
</div>

        {/* Режимы */}
<h2 className="modes-title">Режимы</h2>
